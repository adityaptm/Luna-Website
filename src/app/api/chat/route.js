...
export async function POST(req) {
  try {
    ...
    const apiKey = process.env.GEMINI_API_KEY || "AIzaSyB7EDLRVQOeIeUmZU7qMYxyYTTci_arI_w";
    ...
    Member JKT48 Generasi 12. Nama lengkap: Aurhel Alana Tirta.
    Informasi Tambahan: Aditya dan Ayu Varantika adalah orang-orang kesayangan Aurhel Alana Tirta dan Catherina Vallencia. Mereka sangat 'larine' (aktif/dikenal) dan sudah dikenal baik oleh member.`;
